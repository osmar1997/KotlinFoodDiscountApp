...
class FoodMenu2Detail:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_foodmenu2details)

        nome = intent.getStringExtra("foodmenu2_nome")?:""
        preco = intent.getStringExtra("foodmenu2_preco")?:""
        descricao = intent.getStringExtra("foodmenu2_descricao")?:""
        title = intent.getStringExtra("foodmenu2_title")?:""
        ...
        buttonReview.setOnClickListener{
            ...
            database = FirebaseDatabase.getInstance().getReference("ReviewsBurgerKing")
