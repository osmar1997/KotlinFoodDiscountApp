...
class FoodMenu4Detail:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_foodmenu4details)

        nome = intent.getStringExtra("foodmenu4_nome")?:""
        preco = intent.getStringExtra("foodmenu4_preco")?:""
        descricao = intent.getStringExtra("foodmenu4_descricao")?:""
        title = intent.getStringExtra("foodmenu4_title")?:""
        ...
        buttonReview.setOnClickListener{
            ...
            database = FirebaseDatabase.getInstance().getReference("ReviewsSteakShake")
