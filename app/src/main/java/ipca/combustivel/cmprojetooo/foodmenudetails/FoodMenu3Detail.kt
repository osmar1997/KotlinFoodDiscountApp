...
class FoodMenu3Detail:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_foodmenu3details)

        nome = intent.getStringExtra("foodmenu3_nome")?:""
        preco = intent.getStringExtra("foodmenu3_preco")?:""
        descricao = intent.getStringExtra("foodmenu3_descricao")?:""
        title = intent.getStringExtra("foodmenu3_title")?:""
        ...
        buttonReview.setOnClickListener{
            ...
            database = FirebaseDatabase.getInstance().getReference("ReviewsKFC")
